...
static Key keys[] = {
    ...
    { ShiftMask|ControlMask,        XK_Up,      spawn,   {.v = cmusstop } },
    { 0,                            0x1008ff14, spawn,   {.v = cmusplay } },
    { ShiftMask|ControlMask,        XK_Down,    spawn,   {.v = cmusplay } },
    { 0,                            0x1008ff17, spawn,   {.v = cmusnext } },
    { ShiftMask|ControlMask,        XK_Right,   spawn,   {.v = cmusnext } },
    { 0,                            0x1008ff16, spawn,   {.v = cmusprev } },
    { ShiftMask|ControlMask,        XK_Left,    spawn,   {.v = cmusprev } },
